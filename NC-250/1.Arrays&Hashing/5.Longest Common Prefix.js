...
// Time complexity: O(n * m) where n is the number of strings and m is the length of the prefix (checking up to m characters for all n strings)
...
// Horizontal Scaling
// Time complexity: O(n * m) where n is the number of strings and m is the length of the prefix (iterating up to m characters per string across n strings)
...
// Sorting
// Time complexity: O(n * m log n) where n is the number of strings and m is the length of the longest string (sorting strings)
// Space complexity: O(1) or O(n * m) where n is the number of strings and m is the length of the longest string (depending on the sorting algorithm)
